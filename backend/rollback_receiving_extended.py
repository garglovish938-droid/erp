"""
Database Rollback Script - Extended Stock Transaction Fields
Restores the database to the state before the extended fields migration.
"""
import os
import shutil
import glob
...
def rollback():
    ...
    # Find all backup files starting with erp_backup_txn_extended_
    pattern = os.path.join(BACKUP_DIR, "erp_backup_txn_extended_*.db")
