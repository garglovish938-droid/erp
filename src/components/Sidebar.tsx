...
import { 
  ...
  Settings, LogOut, ArrowLeftRight, Smile, Truck, FileText 
} from "lucide-react";
...
export default function Sidebar({ activeTab, setActiveTab, userRole, onLogout }: SidebarProps) {
  const allMenu = [
    { id: "dashboard", label: "Dashboard", icon: LayoutDashboard, roles: ["admin", "manager", "store", "accountant"] },
    { id: "inventory", label: "Inventory", icon: PackageSearch, roles: ["admin", "manager", "store", "accountant"] },
    { id: "projects", label: "Projects", icon: FolderKanban, roles: ["admin", "manager"] },
    { id: "requests", label: "Material Requests", icon: ArrowLeftRight, roles: ["admin", "manager", "store"] },
    { id: "purchasing", label: "Purchasing", icon: ShoppingCart, roles: ["admin", "store", "accountant"] },
    { id: "crm", label: "CRM (Clients)", icon: Smile, roles: ["admin", "manager", "accountant"] },
    { id: "suppliers", label: "Suppliers", icon: Truck, roles: ["admin", "manager", "store", "accountant"] },
    { id: "team", label: "Team & HR", icon: Users, roles: ["admin", "manager", "store", "accountant", "worker"] },
    { id: "reports", label: "Reports", icon: FileText, roles: ["admin", "manager", "accountant"] },
