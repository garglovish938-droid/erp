...
import { ArrowLeftRight, CheckCircle2, XCircle, Package, Calendar, User, FileText, Loader2 } from "lucide-react";
              ...
              <div className="space-y-3 flex-1">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1 font-semibold">
                    Project: <span className="text-indigo-600 dark:text-indigo-400">{req.project?.name}</span>
                  </p>
                </div>
                    ...
                    <>
                      ...
                      {req.status === "pending" && isManager && (
                        <>
                          <button
                            ...
                            className="p-2 bg-rose-50 hover:bg-rose-100 text-rose-600 dark:bg-rose-950/20 dark:text-rose-400 rounded-xl transition-all border border-rose-200/30 dark:border-rose-900/30"
                          ...
                          <button
                            ...
                            className="p-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl transition-all shadow-md shadow-indigo-100 dark:shadow-none"
                      ...
                      {req.status === "approved" && isStore && (
                        <button
                          ...
                          className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs rounded-xl transition-all shadow-lg flex items-center gap-1.5"
                        >
